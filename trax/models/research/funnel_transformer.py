...
#TODO(mvxxx) remove PrintShape - it is just for debug
  return tl.Serial(tl.PrintShape(6, 'Funnel loss layer'), tl.Branch(gen_loss, cls_loss), tl.WeightedAdd(1.0))
...
#TODO(mvxxx) remove - it is just for debug
