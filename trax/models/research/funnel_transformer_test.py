...
from trax.models.research.funnel_transformer import MeanPool, _FunnelResidualBlock, \
...
class FunnelTransformerTest(parameterized.TestCase):
    ...
    def test_funnel_block_forward_shape(self):
        ...
        block = tl.Serial(*_FunnelResidualBlock(d_model, 64, 1, 0.1, None, 'train', tl.Relu))
